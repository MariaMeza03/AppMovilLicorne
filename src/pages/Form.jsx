                ...
                {({ handleChange, handleBlur, handleSubmit, values , errors }) => (
                    ...
                    <StyleContainer content_form_form_formik >
                        ...
                        <StyleContainer content_input>
                            ...
                            <StyleInput placeholder="Tú dirección de correo electrónico" name="email" value={values.email} onBlur={handleBlur('email')} onChangeText={handleChange('email')} input/>
                                {errors.email &&
                        ...
                        <StyleContainer content_input>
                            ...
                            <StyleInput placeholder="Tú respuesta" name="url" value={values.url} onBlur={handleBlur('url')} onChangeText={handleChange('url')} input/>
                                {errors.url &&
                        ...
                        <StyleContainer content_input>
                            ...
                            <StyleInput placeholder="Tú respuesta" name="object" vale={values.object} onBlur={handleBlur('object')} onChangeText={handleChange('object')} input/>
                                {errors.object &&
                        ...
                        <StyleContainer content_input>
                            ...
                            <StyleInput placeholder="Tú respuesta" name="presupuesto" value={values.presupuesto} onBlur={handleBlur('presupuesto')} onChangeText={handleChange('presupuesto')} input/>
                                {errors.presupuesto &&
